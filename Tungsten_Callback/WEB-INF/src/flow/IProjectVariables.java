...
public interface IProjectVariables {
	...
	public static final String COLLECT_PHONE_NO = "CollectPhoneNo";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String CALL_DATA = "CallData";
	public static final String SESSION = "session";
	public static final String TO_GET_CALL_BACK_MENU = "ToGetCallBackMenu";
	public static final String NUMBER_ENTERED_IS__MN = "NumberEnteredIs_MN";
	...
	public static final String CALL_BACK_FIELD_AGENT_AVAILABILITY = "AgentAvailability";
	public static final String CALL_BACK_FIELD_CUSTOMER = "customer";
	public static final String CALL_BACK_FIELD_MAX_TRIES_FOR_CALLING_AGENT_AVAILABILITY_API = "MaxTriesForCallingAgentAvailabilityAPI";
	public static final String CALL_BACK_FIELD_MAX_TRIES_TO_GET_NEW_PHONE_NO = "MaxTriesToGetNewPhoneNo";
	public static final String CALL_BACK_FIELD_NEW_NUMBER = "NewNumber";
	public static final String CALL_BACK_FIELD_REST_APIRESPONSE = "RestAPIResponse";
	public static final String COLLECT_PHONE_NO_FIELD_CONFIDENCE = "confidence";
	public static final String COLLECT_PHONE_NO_FIELD_INPUTMODE = "inputmode";
	public static final String COLLECT_PHONE_NO_FIELD_INTERPRETATION = "interpretation";
	public static final String COLLECT_PHONE_NO_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String COLLECT_PHONE_NO_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String COLLECT_PHONE_NO_FIELD_UTTERANCE = "utterance";
	public static final String COLLECT_PHONE_NO_FIELD_VALUE = "value";
	...
	public static final String CALL_DATA_FIELD_PREVIOUS_NODE = "PreviousNode";
	public static final String CALL_DATA_FIELD_STANDARD_ERR__REASON = "StandardErr_Reason";
	...
	public static final String TO_GET_CALL_BACK_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_UTTERANCE = "utterance";
	public static final String TO_GET_CALL_BACK_MENU_FIELD_VALUE = "value";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_CONFIDENCE = "confidence";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_INPUTMODE = "inputmode";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_INTERPRETATION = "interpretation";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_UTTERANCE = "utterance";
	public static final String NUMBER_ENTERED_IS__MN_FIELD_VALUE = "value";
