 ...
 * Last generated by Orchestration Designer at: 2023-JUL-31  09:28:09 PM
 */
public class UpdateNewNumberServlet extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		try {
			...
			String phoneno=mySession.getVariableField(IProjectVariables.CALL_BACK, IProjectVariables.CALL_BACK_FIELD_NEW_NUMBER).getStringValue();
		
			app.updateNewNumberForCallback(cust, phoneno);
			
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"New phone number added for callback..", mySession); 
