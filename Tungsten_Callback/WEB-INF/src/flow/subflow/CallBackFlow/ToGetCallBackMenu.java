 ...
 * Last generated by Orchestration Designer at: 2023-JUL-06  12:33:02 PM
 */
public class ToGetCallBackMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Same Number", "1", true, "exact", "CallBackFlow-DBServlerForCallback", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("New number", "2", true, "exact", "CallBackFlow-CollectPhoneNo", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Disconnect", "3", true, "exact", "CallBackFlow-ThankYouContact", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("ToGetCallBack", ""));
