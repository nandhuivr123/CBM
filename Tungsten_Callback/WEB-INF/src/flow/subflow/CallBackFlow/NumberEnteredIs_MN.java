 ...
 * Last generated by Orchestration Designer at: 2023-JUL-06  01:37:42 PM
 */
public class NumberEnteredIs_MN extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("ToConfirm", "1", true, "exact", "CallBackFlow-UpdateNewNumberServlet", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Reenter", "2", true, "exact", "CallBackFlow-isMaxItiesExceeded", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("NumberEnteredAnnc", ""));
