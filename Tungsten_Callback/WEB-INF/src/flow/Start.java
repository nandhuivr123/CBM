...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("Welcome_PP");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.CALL_BACK_FIELD_AGENT_AVAILABILITY,
			IProjectVariables.CALL_BACK_FIELD_CUSTOMER,
			IProjectVariables.CALL_BACK_FIELD_MAX_TRIES_FOR_CALLING_AGENT_AVAILABILITY_API,
			IProjectVariables.CALL_BACK_FIELD_MAX_TRIES_TO_GET_NEW_PHONE_NO,
			IProjectVariables.CALL_BACK_FIELD_NEW_NUMBER,
			IProjectVariables.CALL_BACK_FIELD_REST_APIRESPONSE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CALL_BACK, variableFields, new String[] {"", "", "3", "2", "", ""}, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.CUSTOMER, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.COLLECT_PHONE_NO_FIELD_CONFIDENCE,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_INPUTMODE,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_INTERPRETATION,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_NOINPUTCOUNT,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_NOMATCHCOUNT,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_UTTERANCE,
			IProjectVariables.COLLECT_PHONE_NO_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.COLLECT_PHONE_NO, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CALL_DATA_FIELD_PREVIOUS_NODE,
			IProjectVariables.CALL_DATA_FIELD_STANDARD_ERR__REASON };
		...
		variableFields = new String[] {
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_CONFIDENCE,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_INPUTMODE,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_INTERPRETATION,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_UTTERANCE,
			IProjectVariables.TO_GET_CALL_BACK_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.TO_GET_CALL_BACK_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_CONFIDENCE,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_INPUTMODE,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_INTERPRETATION,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_NOINPUTCOUNT,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_NOMATCHCOUNT,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_UTTERANCE,
			IProjectVariables.NUMBER_ENTERED_IS__MN_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.NUMBER_ENTERED_IS__MN, variableFields, null, session, false, false );
		session.putVariable(variable);
