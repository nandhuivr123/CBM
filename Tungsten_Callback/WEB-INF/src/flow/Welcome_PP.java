 ...
 * Last generated by Orchestration Designer at: 2023-JUL-06  10:13:36 AM
 */
public class Welcome_PP extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Welcome_PP", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CallCenterSpecialist");
		return submit;
	}
	/**
